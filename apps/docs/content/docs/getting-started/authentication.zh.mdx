---
title: 身份验证
description: 了解如何使用 Memokit API 进行身份验证
---

# 身份验证

所有 Memokit API 请求都需要使用 API 密钥进行身份验证。

## API 密钥

API 密钥用于对 Memokit API 的请求进行身份验证。每个 API 密钥：
...
1. 登录 [Memokit 控制台](https://console.memokit.dev)
2. 在侧边栏中导航至 **API 密钥**
3. 点击 **创建 API 密钥**
4. 为密钥起一个描述性名称
5. 立即复制密钥
